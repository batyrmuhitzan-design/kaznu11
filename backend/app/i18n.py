...
APP_STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "Club Event": "社团活动",
        "Club Events": "社团活动",
        "Global Notification": "全校通知",
        "Global Notifications": "全校通知",
        "Category": "分类",
        "Post Content": "帖子内容",
        ...
        "🔔 Activate": "🔔 启用",
        "🔕 Deactivate": "🔕 停用",
        "Hide the selected posts?": "确定隐藏选中的帖子吗？",
        "Unhide the selected posts?": "确定恢复显示选中的帖子吗？",
        "Approve the selected events?": "确定通过选中的活动吗？",
        "Unapprove the selected events?": "确定取消通过选中的活动吗？",
        "Activate the selected notifications?": "确定启用选中的通知吗？",
        "Deactivate the selected notifications?": "确定停用选中的通知吗？",
    },
    "ru": {
        # ---- меню: категории ----
        ...
        "Club Event": "Мероприятие",
        "Club Events": "Мероприятия",
        "Global Notification": "Общее уведомление",
        "Global Notifications": "Общие уведомления",
        "Category": "Категория",
        ...
        "Event Time": "Дата и время",
        "Location": "Место",
        "Register Link": "Ссылка на запись",
        "Poster URL": "Ссылка на постер",
        ...
        "Level": "Уровень",
        "Active": "Активно",
        # ---- Campus Hub: массовые действия ----
        "🙈 Hide": "🙈 Скрыть",
        "👁 Unhide": "👁 Показать",
        "⛔ Unapprove": "⛔ Снять одобрение",
        "🔔 Activate": "🔔 Включить",
        "🔕 Deactivate": "🔕 Отключить",
        "Hide the selected posts?": "Скрыть выбранные посты?",
        "Unhide the selected posts?": "Показать выбранные посты?",
        "Approve the selected events?": "Одобрить выбранные мероприятия?",
        "Unapprove the selected events?": "Снять одобрение с выбранных мероприятий?",
        "Activate the selected notifications?": "Включить выбранные уведомления?",
        "Deactivate the selected notifications?": "Отключить выбранные уведомления?",
    },
}
